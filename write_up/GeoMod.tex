...
\begin{table}[H]
  ...
  \begin{tabular}{l |c c c c |}
    ...
    \cline{2-5}
    \parbox[t]{2mm}{\multirow{6}{*}
        {\rotatebox[origin=t]{90}{$\longleftarrow u$}}} 
    &0        & $N$     & \dots  & $N(M-1)$   \\
    &1        & $N+1$   & \dots  & $N(M-1)+1$ \\
    &2        & $N+2$   & \dots  & $N(M-1)+2$ \\
