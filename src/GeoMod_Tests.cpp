...
void test10()
{
  ...
  double p4[3]  = { 7.0, -3.0, 0.0}; 
  // second 'row'               
  double p5[3]  = {-5.0, 0.0, 0.0};
  double p6[3]  = {-2.0, 0.0, 0.0};
  double p7[3]  = { 3.0, 0.0, 0.0};
  double p8[3]  = { 7.0, 0.0, 0.0}; 
  // third 'row'            
  double p9[3]  = {-5.0, 3.0, 0.0};
  double p10[3] = {-2.0, 3.0, 0.0};
  double p11[3] = { 3.0, 3.0, 0.0};
